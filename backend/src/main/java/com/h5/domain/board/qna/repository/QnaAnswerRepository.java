...
@Repository
public interface QnaAnswerRepository extends JpaRepository<com.h5.domain.board.qna.entity.QnaAnswerEntity, Integer> {
    List<com.h5.domain.board.qna.entity.QnaAnswerEntity> findByQnaEntity_IdAndDeleteDttmIsNull(Integer qnaId);
